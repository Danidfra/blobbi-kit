...
export const BLOBBI_TAG_SCHEMA: readonly BlobbiTagSchema[] = [
  ...
  },
  {
    ...
    format: 'positive integer',
    defaultValue: '1',
    notes: 'Starts at 1 on first activity. Increments when activity occurs on the next calendar day. Resets to 1 if 2+ days are missed. Persists across stages.',
  },
  {
    tag: 'care_streak_last_at',
    description: 'Unix timestamp (seconds) of last streak update',
    category: 'progression',
    required: false,
    stages: ['egg', 'baby', 'adult'],
    persistent: true,
    ...
    notes: 'Stores when the streak was last updated. Used alongside care_streak_last_day for debugging and validation.',
  },
  {
    tag: 'care_streak_last_day',
    description: 'Local calendar day (YYYY-MM-DD) of last streak update',
    category: 'progression',
    required: false,
    stages: ['egg', 'baby', 'adult'],
    persistent: true,
    ...
    format: 'YYYY-MM-DD',
    defaultValue: undefined,
    notes: 'Stores the local calendar day when streak was last counted. Used to prevent double-counting on the same day and to calculate days missed.',
  },
